...
var DefaultConfig = &Config{
	...
	LearningRate:          .007, //This will need to scale down with each iteration
...
type Config struct {
	...
	ReluCap               float64 //the capped output of the relu function, e.g. relu6
	LearningRate          float64
	TrainingCondition     float64 //the minimum value that the average error must reach to terminate training
	ReluLeak              float64
}

func NewConfig(a, o, c, d, m, s int, l, b, r, rc float64) *Config {
	return &Config{
